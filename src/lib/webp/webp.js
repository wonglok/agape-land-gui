    ...
    api: () => {
      if (!Object.keys(WasmWebp.memoizedModuleAPI).length) {
        WasmWebp.memoizedModuleAPI = {
          ...
          destroyBuffer: WebPMod.cwrap('destroy_buffer', '', ['number']),
          ...
          getResultPointer: WebPMod.cwrap('get_result_pointer', 'number', []),
          getResultSize: WebPMod.cwrap('get_result_size', 'number', []),
