...
export function CaveWalk({ fromPos = [0, 0, 0] }) {
  ...
  //public/
  let querlo = useGLTF(`/places/cave/cave-yo.glb`)
  ...
  cloneQuerlo.scale.setScalar(0.5)
  colliderScene.add(cloneQuerlo)
  let island = cloneQuerlo.getObjectByName('cave')
  if (island) {
    island.material.map.wrapS = island.material.map.wrapS = RepeatWrapping
    island.material.map.repeat.set(30, 30)
    island.material.normalMap.wrapS = island.material.normalMap.wrapS =
      RepeatWrapping
    island.material.normalMap.repeat.set(30, 30)
    island.material.roughnessMap.wrapS = island.material.roughnessMap.wrapS =
      RepeatWrapping
    island.material.roughnessMap.repeat.set(30, 30)
    island.material.metalnessMap.wrapS = island.material.metalnessMap.wrapS =
      RepeatWrapping
    island.material.metalnessMap.repeat.set(30, 30)
  }

  cloneQuerlo.traverse((it) => {
    if (it.material && it.material.name === 'Spiderweb') {
      let Spiderweb = it
      if (Spiderweb) {
        Spiderweb.material.alphaMap = Spiderweb.material
        Spiderweb.material.alphaTest = 0.65
        Spiderweb.material.transparent = true
      }
    }
  })
